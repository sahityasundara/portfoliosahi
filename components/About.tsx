  ...
  return (
    <div className="relative py-16 sm:py-20 md:py-24 px-4">
      <div className="text-center mb-12 sm:mb-16">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900">About Me</h2>
        <p className="mt-2 sm:mt-4 text-base sm:text-lg text-slate-500">A little bit about my journey and passion.</p>
      </div>
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 lg:gap-16">
        <div className="flex-shrink-0">
          <div className="relative group w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64">
        ...
        <div className="w-full md:w-1/2 text-base sm:text-lg space-y-4 text-slate-600 text-center md:text-left">
          <p>
